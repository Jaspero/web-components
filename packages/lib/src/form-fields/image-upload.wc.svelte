...
<div class="flex">
  <input type="text" bind:value={url} disabled={isLocal}>
  <div>
  ...
  <div class="relative w-4">
    ...
    <input type="file" accept={service.acceptedFiles} class="absolute z-10 opacity-0 w-full h-full left-0 top-0 cursor-pointer">
  </div>
</div>
<!--<input type="file" {id} {name} accept={service.acceptedFiles} on:change={(e) => service.imageChange(e)} />-->