<script lang="ts">
  ...
  //EDITORS
  import CodeEditorDemo from './EditorsDemos/CodeEditorDemo.svelte';
  import JsonEditorDemos from './EditorsDemos/JSONEditorDemos.svelte';
  //OTHERS
  ...
  import ImageGalleryDemo from './OtherDemos/ImageGalleryDemo.svelte';
